...
const Measures = () => {
  ...
  const strukturtext = [`${name} benötigt heute strukturierte Maßnahmen durch das Betreuerteam, was sich auch als wirkungsvoll zeigte. `,
                        `Heute mussten bei ${name} Maßnahmen zur Aufrechterhaltung der Struktur angewandt werden. `,
  ...
  const einzelsettingtext = [`${name} benötigt heute viel Betreuung im Einzelsetting, wodurch die Anliegen wahr genommen werden konnten. `,
                             `Heute braucht es mit ${name} einige Zeit im Einzelsetting, da immer wieder direkte pädagogische Begleitung notwendig war. `,
                             `Am Vormittag war es notwendig, ${name} im 1:1-Setting zu betreuen, was sich als pädagogisch wertvoll erwies. `, ];
  const beobachtungstext = [`${name} braucht heute Vormittag außerdem akribische Beobachtung, um ${name}'s Sicherheit zu gewährleisten. `,
                            ...
                            `An diesem Tag stand ${name} immer wieder unter Beobachtung, damit bei Bedarf pädagogische Maßnahmen gesetzt werden konnten. `, ];
  const unterstützungstext = [`${name} benötigt heute viel Unterstützung durch das Betreuerteam, da an diesem Vormittag die Alltagstätigkeiten schwer fallen. `, 
                              `Am heutigen Vormittag bedarf es bei ${name} vermehrt an unterstützenden Maßnahmen, um den Tag bestreiten zu können. `,
  ...
  const verbaleanleitungstext = [`${name} benötigt diesen Vormittag verbale Anleitung beim Ausführen diverser Aufgaben durch das Betreuerteam. `,
                                 `Heute Vormittag brauchte es bei ${name} vermehrt verbale Anleitung zur Orientierung, was sich als durchaus pädagogisch wertvoll zeigte. `,
